...
@section('page-title', 'Historique des transferts commissionnaires')

@section('content')
<div class="pt-4 max-w-6xl">
    <div class="card">
        <h3 class="font-semibold text-gray-800 mb-4">Tous les transferts (crédits + retraits)</h3>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="text-left border-b border-gray-200">
                        ...
                        <th class="pb-3 font-semibold text-gray-600">Commissionnaire</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr>
                        ...
                        <td class="py-3 font-medium text-gray-800">{{ $tx->commissionnaire?->name ?? '—' }}</td>
                        <td class="py-3">
