...
@section('content')
<div class="space-y-6 pt-4" x-data="{ showAdd: false, editId: null, editData: {} }">
    ...
    <div class="rounded-2xl p-6 text-white relative overflow-hidden"
        ...
        <div class="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                <div class="text-blue-200 text-xs font-medium uppercase tracking-widest mb-1">Gestion</div>
                <h2 class="text-2xl font-bold flex items-center gap-3">
                    <i class="fas fa-motorcycle text-amber-400"></i>Livreurs
                </h2>
                <p class="text-blue-200 text-sm mt-1">{{ $livreurs->count() }} livreur(s) enregistré(s)</p>
            </div>
    ...
    <div class="grid grid-cols-3 gap-4">
        ...
        <div class="card text-center">
            ...
            <div class="text-xs text-gray-500 mt-1">Courses en cours</div>
        </div>
        <div class="card text-center">
            <div class="text-3xl font-black text-green-600">{{ $delivered }}</div>
    ...
    <div class="card p-0 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
            ...
            <h3 class="font-bold text-gray-800">Équipe de livraison</h3>
        </div>
                    ...
                    <tr class="table-row">
                        ...
                        <td class="table-cell">
                            <div class="flex items-center gap-1">
                                ...
                                <form action="{{ route('livreurs.token', $livreur) }}" method="POST"
                                ...
                                <form action="{{ route('livreurs.destroy', $livreur) }}" method="POST"
...
<div x-show="showAdd" x-cloak
    ...
    <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md p-7">
        ...
        <form action="{{ route('livreurs.store') }}" method="POST" class="space-y-4">
            @csrf
            <div>
...
<div x-show="editId !== null" x-cloak
    ...
    <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md p-7">
        ...
        <form :action="`{{ url('/livreurs') }}/${editId}`" method="POST" class="space-y-4">
            @csrf @method('PUT')
            <div>
                <label class="form-label">Nom complet *</label>
